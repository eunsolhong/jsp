...
<tr height="30">
<td colspan="2" align="center"><strong><h1>회원로그인</h1></strong></td></tr>
<tr height="30">
<td width="110" align="center"><h3>아이디</h3></td>
<td width="150" align="center">
<input type="text" name="id" size="15" maxlength="12" autocomplete=off></td></tr>
<tr height="30">
<td width="110" align="center"><h3>비밀번호</h3></td>
<td width="150" align="center">
...
onclick = "javascrip:window.location='inputForm.jsp'"></td></tr>
</TABLE>
